...
public class Main extends Application{
    ...
    public void start(Stage primaryStage){
        tela("/launchs/tela_menu.fxml", "MalinhaViagens", primaryStage);
    }
    ...
    public static void changeScreen(String scr){
        ...
        switch (scr){
            case "main":
                main.tela("/launchs/tela_menu.fxml", "MalinhaViagens", stage);
                break;
            ...
            case "cadastrarVeiculo":
                ...
                break;
            case "alterarVeiculo":
                main.tela("/launchs/alterar_cadastro_veiculo.fxml", "Alterar cadastro de veículo", stage);
                break;
