...
public class Consulta{
    ...
    public static class ConsultaViagens {
        ...
        private String nascimentoViajante;
        ...
        public ConsultaViagens(Integer idViagem, String horaPartida, String horaRetorno,
            String cpfViajante, String nomeViajante, String nascimentoViajante, String sexoViajante,
        ...
        public String getNascimentoViajante(){return nascimentoViajante;}    
        public void setNascimentoViajante(String nascimentoViajante){this.nascimentoViajante = nascimentoViajante;}
    ...
    public ObservableList<Consulta.ConsultaViagens> atualizar(){
        ...
        ResultSet rs = stmt.executeQuery("SELECT " +
            ...
            while (rs.next()){
                ...
                java.time.LocalDate nascimentoViajanteData = rs.getObject("nascimento_viajante", java.time.LocalDate.class);
                DateTimeFormatter nascimentoViajanteDataFormat = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                String nascimentoViajante = nascimentoViajanteData.format(nascimentoViajanteDataFormat);
    ...
    public void obter_viagens(Stage stage){
        Main main = new Main();
        main.tela("/launchs/consultar_viagem.fxml", "Tela de consulta", stage);
